...
class B2BMarketResearch(Base):
    __tablename__ = "b2b_market_research"

    __table_args__ = (
        Index("idx_b2b_market_research_home_lc_id", "home_lc_id"),
        Index("idx_b2b_market_research_home_lc_created_at", "home_lc_id", "created_at"),
    )
    ...
    reason_for_approach: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
